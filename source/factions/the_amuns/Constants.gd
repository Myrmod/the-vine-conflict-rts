...
const STRUCTURES = {
	...
	{
		"scene": "res://source/factions/the_amuns/structures/Purifier.tscn",
		"unit_name": "Purifier",
...
const AIR = {
	...
	Enums.SceneId.AMUNS_SYPHON_DRONE:
	{
		"scene": "res://source/factions/the_amuns/units/SyphonDrone.tscn",
		"unit_name": "amuns_SyphonDrone",
		"description": "Flying resource gatherer for Syphon structures.",
		"faction": Enums.Faction.AMUNS,
		"production_tab_type": Enums.ProductionTabType.AIR,
		"production_tab_grid_slot": Enums.ProductionTabGridSlots.F2,
		"sight_range": 8.0,
