...
func _setup_cursor():
	...
	box_mesh.size = Vector3(cell_size * 0.9, 0.3, cell_size * 0.9)
...
func _setup_affected_cells_multimesh():
	...
	var box_mesh = BoxMesh.new()
	box_mesh.size = Vector3(cell_size * 0.8, 0.2, cell_size * 0.8)
...
func set_cursor_color(color: Color):
	...
	if _affected_cells_mesh and _affected_cells_mesh.multimesh.mesh:
		_affected_cells_mesh.multimesh.mesh.material.albedo_color = Color(color.r, color.g, color.b, 0.3)
